        ...
        <div class="navbar navbar-inverse navbar-fixed-top animated fadeInDown" role="navigation" id="top-nav">
          <div class="container">
            <div class="navbar-header">
              <!-- Logo Starts -->
              <a class="navbar-brand" href="#home"><img src="assets/images/unape.png" height="30" alt="logo"/> - UNAPE IMBABURA</a>
              <!-- #Logo Ends -->
...
<div class="row">
	...
	<div class="fronttext">
  <center>
	 	<h1 class="bgcolor  animated fadeInUpBig">Union de Artistas populares del Ecuador</h1><br>
	...
	<div class="player">
	<img src="assets/images/unape.png" class="graphics hidden-xs  animated fadeInRightBig" alt="Unape Imbabaura" style="width:250px" />
...
<h3><span class="glyphicon glyphicon-user"></span> Misión - Visión</h3>
<div class="row">				
<div class="col-lg-4 col-sm-4  col-xs-12">
<img src="assets/images/unape.png" class="img-responsive" alt="about"/>
</div>
<div class="col-lg-5 col-sm-8  col-xs-12">
<p>Ser una organización que reúna artistas con conciencia de clase, para luchar por el fortalecimiento de los derechos de identidad pluricultural de los pueblos y de la naturaleza, a través de la creación del arte popular, pluricultural y emancipador contribuyendo de esta manera con el desarrollo social.</p>
<blockquote>La Unión de Artistas Populares del Ecuador filial Imbabura (UNAPE-I), para el año 2022 será el referente de los artistas populares de la zona norte del país , dotada de expresiones propias con conciencia de clase y su lucha permanente por un mundo mejor, incluyendo positivamente la participación activa de artistas afiliados en toda la provincia</blockquote>
</div>
<div class="col-lg-3 visible-lg">
<div class="fb-like-box" data-href="https://www.facebook.com/pg/UNAPEImbabura/about/?ref=page_internal" data-colorscheme="dark" data-show-faces="true" data-header="false" data-stream="false" data-show-border="false" data-width="255"></div>
</div>
</div>
</div>
<!-- About Ends -->
...
<div class="row">
	...
	<div class="col-md-6 col-xs-12">
		<div class="events">
		<h3><span class="glyphicon glyphicon-calendar"></span> Eventos</h3>
		<ul>
			<li>
			<div class="row">
				...
				<div class="col-xs-12  col-sm-6 col-lg-5 "><h5><a href="#" data-toggle="modal" data-target="#blogdetail">lanzamiento Marca Institucional</a></h5><p>Lugar: Auditorio del GPI (Sucre y García Moreno)
Hora: 18:00</p></div>
				<div class="col-xs-12  col-sm-3 col-lg-3 date"><b>2018</b><span>Abril 20</span></div>
			</div>
			</li>
			<li>
			<div class="row">
				...
				<div class="col-xs-12  col-sm-6 col-lg-5 "><h5><a href="#" data-toggle="modal" data-target="#blogdetail">Gestión Cultural</a></h5><p>Es la posibilidad de construir otras realidades desde el territorio.</p></div>
				<div class="col-xs-12  col-sm-3 col-lg-3 date"><b>2018</b><span>Abril 23</span></div>
			</div>
			</li>
			<li>
			<div class="row">
				<div class="col-xs-12 col-sm-3 col-lg-4"><a href="#" data-toggle="modal" data-target="#blogdetail"><img src="assets/images/3.jpg" height="200" class="img-responsive" alt="music theme" /></a></div>
				<div class="col-xs-12  col-sm-6 col-lg-5 "><h5><a href="#" data-toggle="modal" data-target="#blogdetail">Talleres</a></h5><p>Inscripciones 5 al 31 de Marzo.</p></div>
				<div class="col-xs-12  col-sm-3 col-lg-3 date"><b>2018</b><span>Abril 1</span></div>
			</div>
			</li>
			<li>
			<div class="row">
				...
				<div class="col-xs-12  col-sm-6 col-lg-5 "><h5><a href="#" data-toggle="modal" data-target="#blogdetail">Artistas Danielistas</a></h5><p>Typewriter photo booth vinyl post-ironic, literally keffiyeh locavore tofu lomo pug Odd Future.</p></div>
				<div class="col-xs-12  col-sm-3 col-lg-3 date"><b>2018</b><span>Marzo 8</span></div>
			</div>
			</li>
		</ul>
		</div>
